...
function run()
{
    ...
    updateGUI(h);           // Mise à jour de l'interface
...
function init()
{
    ...
    div = inidiv('huffman', 100, 100);

    // Étiquette
    lblProba = Label(div, 'Probabilités :', 0, bdh/2, 'm');
//    var pos = (bdh-lblProba.offsetHeight) / 2
//    lblProba.style.top = pos.toString() + 'px';

    // Texte (valeur des probabilités)
    txtProba = Edit(div, '0.4 0.3 0.2 0.1', lblProba.offsetWidth+sep, 0, 1, bdh);
