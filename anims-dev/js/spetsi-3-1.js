...
function Graph(div, x, y, w, h)
{
    ...
    ctx.axes = function(clr)
    {
        ...
        var z = ctx.pt2px([0, 0]);
        z = [ Math.round(z[0])+0.5 , Math.round(z[1])+0.5 ];
    ...
    // Evènement : souris qui se déplace sans bouton appuyé
    ...
    // Evènement : souris qui se déplace et bouton appuyé
