...
// Objets
var div, gtb, gtf, gfe, gfb, gff, lbl, sld;
...
// Graphes
var xtmax = 5;              // Valeurs extrêmes des abscisses des graphes temporels
var xfmax = 1.5;            // Valeurs extrêmes des abscisses des graphes fréquentiels
var ytmax = 3;              // Valeurs extrêmes des axes des graphes temporels
var yfmax = 1;              // Valeurs extrêmes des axes des graphes fréquentiels

// Sinusoïde originale
var n, t = [], y = [];
var Te = 0.2;               // Pas d'échantillonnage
var xstep = 0.03;           // Pas d'échantillonnage de la sinusoïde "continue"
var fo = 0.5;               // Fréquence de la sinusoïde
var A = 1;                  // Amplitude de la sinusoïde
for(n = -5; n < 5; n=n+xstep )
{
    t.push( n );
...
function init()
{
    ...
    // Slider et étiquette "Te"
    Label(div, '\\(T_e\\) =', (gw+sep)/2, gh+sep);
    lbl = Label(div, Te.toString(), (gw+sep)/2+35, gh+sep);
    sld = Slider(div, (gw+sep)/2+80, gh+sep, gw-80, 0.2, 8, Te, 0.05, draw);
...
function draw()
{
    ...
    {
        z.push( A*Math.sin(2*Math.PI*f*n) );
    }
